...
bool SaveITensorBatched(const std::string& path, const zdl::DlSystem::ITensor* tensor, size_t batchIndex, size_t batchChunk)   //batchIndex is iterating within a batch
{
   if(batchChunk == 0)
