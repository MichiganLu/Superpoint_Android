...
class Superpoint
{
    ...
    public:
        ...
        void extract_descriptor(const std::vector<float> &outputDesc, const std::vector<cv::Point2f> &final_kps, std::vector<std::vector<float>> &descriptor, const int &desc_height, const int &desc_width, const int &desc_channel, const int &hm_channel);
